...
<body>
    ...
    <div class="navbar-sede-bar">
        <button class="active">Nuevo Registro</button>
        <button>Modificar Registro</button>
        <button>Lista de Registros</button>
    </div>
    ...
    <div class="content">
        ...
        <form>
            ...
            <label for="doc">Núm Documento:</label>
            <input type="text" id="doc" name="doc">

            <label for="no_dispositivos">No. Dispositivos:</label>
            <input type="text" id="no_dispositivos" name="no_dispositivos">

            <label for="descripcion">Características:</label>
            <input type="text" id="descripcion" name="descripcion">

            <div class="btn-group">
                <button type="submit" class="btn-generator">Actualizar</button>
