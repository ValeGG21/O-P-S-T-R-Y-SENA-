...
<head>
    ...
    <style>
        ...
        .navbar-user-bar .btn-logout-navbar {
...
<body>
    ...
    <div class="navbar-user-bar">
        ...
        <button class="btn-logout-navbar">Cerrar sesión</button>
    </div>

    <div class="logout-container">
        <h1>Deseas cerrar sesión:</h1>
        <p>Recuerda que para volver a ingresar debes poner usuario y contraseña</p>
        <div class="btn-group">
