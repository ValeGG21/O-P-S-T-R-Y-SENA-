...
<head>
    ...
    <style>
        ...
        .login-container {
            ...
            width: 300px;
            position: relative;
            top: 30px; /* Reducir el espacio entre el navbar y el formulario */
            left: 15%; /* Ubicar el formulario al 15% del lado izquierdo */
        }
        .login-container h1 {
            font-size: 20px;
            color: #333;
...
<body>
    ...
    <div class="login-container">
        ...
        <p>Ingrese el usuario y la contraseña, para el ingreso al sistema</p>
