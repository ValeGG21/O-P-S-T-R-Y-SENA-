...
public class SuperAdminModel {
     public static final String TABLA = "tabla_superadmin" ;
    ...
    public SuperAdminModel(String identificacion, String tipo_documento,  String nombre, String apellido, String sede, String departamento) {
