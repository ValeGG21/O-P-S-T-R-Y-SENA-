...
<head>
    ...
    <title>Lista de Vigilantes</title>
    <style>
        body {
...
<body>
    ...
    <div class="navbar-sede-bar">
        ...
        <button>Modificar Vigilante</button>
        <button>Eliminar Vigilante</button>
        <button class="active">Lista de Vigilantes</button>
    </div>

    <!-- Contenido principal -->
    <div class="content">
        <h1>Lista de Vigilantes</h1>
        <table>
            <thead>
                <tr>
                    <th>ID de Vigilante</th>
                    <th>No. Documento</th>
            ...
            <tbody>
                <!-- Aquí irían las filas de datos de los vigilantes -->
            </tbody>
        </table>
    </div>
</body>
